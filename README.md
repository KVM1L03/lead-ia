...
Every change lands through a pull request. CI runs lint and tests on each PR, plus an advisory LLM diff review. **LeadForge** is the internal codename you'll see in `context/` and the compose service names.
